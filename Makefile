...
# claude-town.io/claude-town-bundle:$VERSION and claude-town.io/claude-town-catalog:$VERSION.
IMAGE_TAG_BASE ?= claude-town.io/claude-town
...
KIND_CLUSTER ?= claude-town-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name claude-town-builder
	$(CONTAINER_TOOL) buildx use claude-town-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm claude-town-builder
	rm Dockerfile.cross
